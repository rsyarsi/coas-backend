...
class EmrKonservasiRepository implements EmrKonservasiRepositoryInterface
{
    ...
    public function updatewaktuperawatan($data)
    {
        ...
        $updates = emrkonservasi::where('id', $data->id)->update([
            ...
            'sblmperawatanfaktorrisikokaries_fluor_pastagigi' => $data->sblmperawatanfaktorrisikokaries_fluor_pastagigi,
            'sblmperawatanfaktorrisikokaries_diet_gula' => $data->sblmperawatanfaktorrisikokaries_diet_gula,
            ...
            'ssdhperawatanfaktorrisikokaries_fluor_pastagigi' => $data->ssdhperawatanfaktorrisikokaries_fluor_pastagigi,
            'ssdhperawatanfaktorrisikokaries_diet_gula' => $data->ssdhperawatanfaktorrisikokaries_diet_gula,
